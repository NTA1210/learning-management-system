...
export const listCoursesSchema = z
  .object({
    ...
    status: z.enum([CourseStatus.DRAFT, CourseStatus.ONGOING, CourseStatus.COMPLETED]).optional(), // Filter by status
...
export const updateCourseSchema = z
  .object({
    ...
    meta: z
      .union([z.record(z.string(), z.any()), z.string().transform((val) => JSON.parse(val))])
      .optional(),
  })
  .refine(
    (data) => {
