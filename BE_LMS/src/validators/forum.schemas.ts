...
export const listForumsSchema = listParamsSchema.extend({
    courseId: z.string().min(1, "courseId is required").refine(val => mongoose.Types.ObjectId.isValid(val), {
...
export const forumIdSchema = z.string().min(1, "forumId is required").refine(val => mongoose.Types.ObjectId.isValid(val), {
...
export const listForumPostsSchema = listParamsSchema.extend({
    authorId: z.string().min(1, "authorId (userId) is required").refine(val => mongoose.Types.ObjectId.isValid(val), {
...
export const postIdSchema = z.string().min(1, "forumPostId is required").refine(val => mongoose.Types.ObjectId.isValid(val), {
...
export const listForumRepliesSchema = listParamsSchema.extend({
    ...
    parentReplyId: z.string().min(1, "forumReplyId from parent is required").refine(val => mongoose.Types.ObjectId.isValid(val), {
...
export const replyIdSchema = z.string().min(1, "forumReplyId is required").refine(val => mongoose.Types.ObjectId.isValid(val), {
