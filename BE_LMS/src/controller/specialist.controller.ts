...
export const createSpecialistHandler = catchErrors(async (req, res) => {
  ...
  const specialist = await createSpecialist({
    ...data,
    majorId: data.majorId as mongoose.Types.ObjectId,
  });
...
export const updateSpecialistByIdHandler = catchErrors(async (req, res) => {
  ...
  // Call service
  const specialist = await updateSpecialistById(specialistId, {
    ...data,
    majorId: data.majorId as mongoose.Types.ObjectId,
  });
...
export const updateSpecialistBySlugHandler = catchErrors(async (req, res) => {
  ...
  // Call service
  const specialist = await updateSpecialistBySlug(slug, {
    ...data,
    majorId: data.majorId as mongoose.Types.ObjectId,
  });
