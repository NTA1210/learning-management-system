    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 py-2 relative">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-center relative">
          ...
          <div className="lg:w-1/2 flex justify-center relative" style={{ position: 'relative', zIndex: 1 }}>
            <div className="w-full rounded-2xl shadow-lg"
              style={{
                backgroundColor: darkMode ? 'rgba(26, 32, 44, 0.6)' : 'rgba(255, 255, 255, 0.9)',
          ...
          <div className="lg:w-1/2">
            ...
            >
              <h2 className="text-2xl font-semibold mb-4" style={{ color: darkMode ? '#93c5fd' : '#4338ca' }}>Our Mission</h2>
              <p className="mb-4" style={{ color: darkMode ? '#9ca3af' : '#374151' }}>
              ...
              <h2 className="text-2xl font-semibold mb-4" style={{ color: darkMode ? '#93c5fd' : '#4338ca' }}>Our Story</h2>
              <p className="mb-4" style={{ color: darkMode ? '#9ca3af' : '#374151' }}>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2" style={{ color: darkMode ? '#93c5fd' : '#4338ca' }}>Interactive Learning</h3>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2" style={{ color: darkMode ? '#93c5fd' : '#4338ca' }}>Seamless Communication</h3>
              <p style={{ color: darkMode ? '#9ca3af' : '#374151' }}>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2" style={{ color: darkMode ? '#93c5fd' : '#4338ca' }}>Comprehensive Assessment</h3>
              <p style={{ color: darkMode ? '#9ca3af' : '#374151' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {teamMembers.map((m, idx) => (
              <a key={idx} href={m.url} target="_blank" rel="noreferrer"
                ...
                style={{
                  background: darkMode ? 'rgba(26, 32, 44, 0.8)' : 'rgba(255, 255, 255, 0.95)',
                  border: '1px solid rgba(148, 163, 184, 0.1)'
                }}
              >
                <div className="p-4 flex items-center gap-4 min-h-[96px]">
                  <img src={m.image} alt={m.title} loading="lazy" className="w-16 h-16 rounded-xl object-cover border flex-shrink-0"
                    style={{ borderColor: m.borderColor }}
                  />
                  <div className="min-w-0">
                    <div className="font-semibold truncate" title={m.title}>{m.title}</div>
                    <div className="text-sm truncate" style={{ color: darkMode ? '#9ca3af' : '#6b7280' }} title={m.subtitle}>{m.subtitle}</div>
                    <div className="text-xs mt-1 truncate" style={{ color: darkMode ? '#a78bfa' : '#4f46e5' }} title={m.handle}>{m.handle}</div>
                  </div>
                </div>
                <div aria-hidden className="absolute bottom-0 left-0 w-full h-1.5"
                  style={{ backgroundImage: m.gradient as unknown as string }}
                />
              </a>
            ))}
          </div>
        ...
        {/* Contact Section */}
        <div className="mt-10 p-8 rounded-xl shadow-lg"
          style={{
            backgroundColor: darkMode ? 'rgba(26, 32, 44, 0.8)' : 'rgba(255, 255, 255, 0.9)',
            border: '1px solid rgba(148, 163, 184, 0.1)'
          }}
