...
import { Navbar, Sidebar, ListToolbar, LessonCard, LessonFormModal } from "../components";
import { httpClient } from "../utils/http";
import { courseService } from "../services";
import type { Lesson, LessonFormValues, LessonSortOption } from "../types/lesson";
...
const ListAllLessonsPage: React.FC = () => {
  ...
  const handleEdit = (lesson: Lesson) => setModalState({ mode: "edit", lesson });
        ...
        <main className="flex-1 relative overflow-y-auto focus:outline-none p-4 mt-16 sm:pl-24 md:pl-28">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <ListToolbar
              ...
              onSortOptionChange={(value) => setSortOption(value as LessonSortOption)}
              pageLimit={pageLimit}
