    ...
    >
      <div className="flex items-start justify-between mb-3">
        <div className="flex-1">
          <h3 className="font-semibold mb-1" style={{ color: darkMode ? "#ffffff" : "#1f2937" }}>
          ...
          {submission.originalName && (
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm" style={{ color: darkMode ? "#d1d5db" : "#6b7280" }}>
                {submission.originalName}
                {submission.size && ` (${(submission.size / 1024).toFixed(2)} KB)`}
              </span>
            </div>
          )}
      ...
      {(submission.grade !== undefined && submission.grade !== null) && (
        <div className="mb-2">
          ...
          <span className="text-sm font-semibold ml-2" style={{ color: darkMode ? "#ffffff" : "#1f2937" }}>
      ...
      {submission.feedback && (
        <div className="mb-3 p-2 rounded" style={{ backgroundColor: darkMode ? "rgba(31, 41, 55, 0.5)" : "#f3f4f6" }}>
      ...
      <div className="flex items-center justify-end gap-2 pt-2 border-t" style={{ borderColor: darkMode ? "rgba(75, 85, 99, 0.3)" : "rgba(229, 231, 235, 0.5)" }}>
        {submission.key && (
          <button
