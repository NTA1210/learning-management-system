...
interface SubjectsTableProps {
  onOpenSubjectModal: (
    subject?: SubjectNode,
    context?: { specialistId: string; specialistName: string }
  ) => void;
...
const SubjectsTable: React.FC<SubjectsTableProps> = ({
  ...
  const getSpecialistNames = (subject: SubjectNode): string => {
    if (!subject.specialistIds || subject.specialistIds.length === 0)
      return "-";

    const specialistNames = subject.specialistIds
      .map((id) => {
