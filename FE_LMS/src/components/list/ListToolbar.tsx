...
import type { AssignmentSortOption } from "../../types/assignment";
import type { LessonSortOption } from "../../types/lesson";

type SortOption = AssignmentSortOption | LessonSortOption;
    ...
    <div className="mb-6 flex flex-col md:flex-row gap-4">
      ...
      <div className="flex items-center gap-3 mr-3 flex-wrap">
        ...
        <button
          className="px-4 py-1 rounded border mx-1 disabled:opacity-40"
          onClick={onNextPage}
          disabled={pageLimit * currentPage >= totalItems}
          title="Next page"
          style={{
            background: darkMode ? "#223344" : "#ffffff",
            color: darkMode ? "#fff" : "#223344",
